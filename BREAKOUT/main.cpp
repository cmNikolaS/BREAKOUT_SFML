...
int main()
{
	...
	loadTex("paddle", "Resources\\paddle.png");
	loadTex("background", "Resources\\background.png");
	loadTex("ball", "Resources\\ball.png");
	loadTex("block_pink", "Resources\\block_pink.png");
	loadTex("block_green", "Resources\\block_green.png");
	loadTex("block_blue", "Resources\\block_blue.png");
	loadTex("block_brown", "Resources\\block_brown.png");
	loadTex("menu_background", "Resources\\menu_background.png");
	...
	sf::Music gameMusic;
	gameMusic.openFromFile("Resources\\djlofi-pixel-dreams-259187.mp3");
